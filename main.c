...
unsigned int SetPoint[row][col] = {{2300, 2070, 1300, 2100, 2050},
                                   {1500, 2070, 1300, 2100, 1950},
                                   {1500, 1570,  800, 2100, 1950},
                                   {1500, 1570,  750, 2100, 2500},
                                   {1500, 1570,  750, 2100, 1950},
                                   {1500, 2070, 1300, 2100, 1950},
                                   {2300, 2070, 1300, 2100, 1950},
                                   {2300, 1570,  800, 2100, 1950},
                                   {2300, 1570,  750, 2100, 2500},
                                   {2300, 1570,  750, 2100, 1950},
                                   {2300, 2070, 1300, 2100, 1950}};
...
unsigned int Gap = 60;			// Gap para a Histerese do Motor 60
...
void MotorCommand(unsigned int SetTarget[col], unsigned int Gap){
    ...
    //if(i==4){
      //  SetPointMax = SetPointMax + 80;
        //SetPointMin = SetPointMin - 80;
    // }
...
//		} //Aguardando outros motores
	...
	case 4: //LOGICA ACIONAMENTO MOTOR 5
                SetPointMax = SetPointMax + 100;
                SetPointMin = SetPointMin - 100;
                __delay_cycles(13000);
